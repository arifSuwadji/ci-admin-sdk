    ...
    'columns' : [
      ...
      { "mRender": function(data, type, full){
          if(adminGrup == 1 || sessionIdAdmin == full['pengguna_id'] && full[19]){
            return '<a href="javascript:void(0);" onClick="gantiPassword('+full['pengguna_id']+')"<button class="btn btn-info btn-xs text-bold">Ganti Password</button>';
          }else{
            return '<a href="javascript:void(0);" onClick="javascript:void(0)"<button class="btn btn-default btn-xs text-bold" disabled>Ganti Password</button>';
          }
      }},
      { "mRender": function(data, type, full){
          if(full[10] && full[12]){
              return '<a href="javascript:void(0);" onClick="editData('+full['pengguna_id']+')"<button class="btn btn-warning btn-xs text-bold">Edit</button></a>&emsp;&emsp;<a href="javascript:void(0);" onClick="hapusData('+full['pengguna_id']+')"><button class="btn btn-danger btn-xs text-bold">Hapus</button></a>';
          }else if(!full[10] && full[12]){
              return '<a href="javascript:void(0);" onClick="javascript:void(0)"<button class="btn btn-default btn-xs text-bold" disabled>Edit</button></a>&emsp;&emsp;<a href="javascript:void(0);" onClick="hapusData('+full['pengguna_id']+')"><button class="btn btn-danger btn-xs text-bold">Hapus</button></a>';
          }else if(full[10] && !full[12]){
            return '<a href="javascript:void(0);" onClick="editData('+full['pengguna_id']+')"<button class="btn btn-warning btn-xs text-bold">Edit</button></a>&emsp;&emsp;<a href="javascript:void(0);" onClick="javascript:void(0)"><button class="btn btn-default btn-xs text-bold" disabled>Hapus</button></a>';
          }else if(!full[10] && !full[12]){

        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title hidden-xs"><?php echo $menuHalaman->sub_judul_menu ?></h3><?php if(isset($buttonPriviliges->{2})){ ?><a href="<?php echo $tambahData ?>"><button class="pull-right btn btn-primary text-bold">Tambah Menu</button></a><?php }else{?><button class="pull-right btn btn-default text-bold" disabled>Tambah Menu</button><?php } ?>
